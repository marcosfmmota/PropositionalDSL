 ...
 * @generated
 */
public class PropdslSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PropdslPackage.PROPOSITION: {
			...
			if (result == null)
				result = caseFormula(proposition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
