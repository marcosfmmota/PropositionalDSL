...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.project.propdsl.Expression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Expression_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Expression_id_feature",
								"_UI_Expression_type"),
						PropdslPackage.Literals.EXPRESSION__ID, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PropdslPackage.Literals.EXPRESSION__FORMULA);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case PropdslPackage.EXPRESSION__ID:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case PropdslPackage.EXPRESSION__FORMULA:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PropdslPackage.Literals.EXPRESSION__FORMULA,
				PropdslFactory.eINSTANCE.createProposition()));

		newChildDescriptors.add(createChildParameter(PropdslPackage.Literals.EXPRESSION__FORMULA,
				PropdslFactory.eINSTANCE.createBinOp()));

		newChildDescriptors.add(createChildParameter(PropdslPackage.Literals.EXPRESSION__FORMULA,
				PropdslFactory.eINSTANCE.createUnOp()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return PropdslEditPlugin.INSTANCE;
	}
